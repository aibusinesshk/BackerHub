/**
 * Local seed script — runs directly against Supabase without Vercel timeout limits.
...
// =====================
// SEED DATA (same as route.ts)
// =====================
const players = [
  { id: 'p1', displayName: 'Chiayun Wu', displayNameZh: '吳佳芸', avatarUrl: '/images/players/chiayun-wu.svg', region: 'TW', isVerified: true, memberSince: '2023-06-01',
    ...
    bio: '2025 Taiwan Player of the Year. Over $1.4M in live earnings.',
    bioZh: '2025年台灣年度最佳選手。現場收入超過140萬美元。',
  },
  { id: 'p2', displayName: 'Chih Feng Li', displayNameZh: '李志峰', avatarUrl: '/images/players/chih-feng-li.svg', region: 'TW', isVerified: true, memberSince: '2023-08-15',
    ...
    bio: '#2 ranked Taiwanese player in 2025 SPI rankings.',
    bioZh: '2025年SPI台灣排名第二。',
  },
  { id: 'p3', displayName: 'Nevan Chang', displayNameZh: '張子龍', avatarUrl: '/images/players/nevan-chang.svg', region: 'TW', isVerified: true, memberSince: '2023-03-10',
    ...
    bio: '#3 ranked Taiwanese player 2025.',
    bioZh: '2025年台灣排名第三。',
  },
  { id: 'p4', displayName: 'Wayne Lam', displayNameZh: '林錦榮', avatarUrl: '/images/players/wayne-lam.svg', region: 'HK', isVerified: true, memberSince: '2023-01-20',
    ...
    bio: '2025 APT Championship winner ($266,992).',
    bioZh: '2025年APT年度總冠軍（$266,992）。',
  },
  { id: 'p5', displayName: 'Zong Chi He', displayNameZh: '何宗祺', avatarUrl: '/images/players/zong-chi-he.svg', region: 'TW', isVerified: true, memberSince: '2023-11-05',
    ...
    bio: '#4 ranked Taiwanese player 2025.',
    bioZh: '2025年台灣排名第四。',
  },
  { id: 'p6', displayName: 'Hao Shan Huang', displayNameZh: '黃浩珊', avatarUrl: '/images/players/hao-shan-huang.svg', region: 'TW', isVerified: true, memberSince: '2024-06-15',
    ...
    bio: 'APT Championship 2025 Main Event finalist.',
    bioZh: '2025年APT年度總冠軍主賽事決賽選手。',
  },
  { id: 'p7', displayName: 'Chi Jen Chu', displayNameZh: '朱志仁', avatarUrl: '/images/players/chi-jen-chu.svg', region: 'TW', isVerified: true, memberSince: '2022-09-01',
    ...
    bio: '#6 in Taiwan SPI 2025 but #1 in total SPI earnings ($1.1M).',
    bioZh: '2025年台灣SPI第六名，但SPI總收入第一（110萬美元）。',
  },
  { id: 'p8', displayName: 'Sparrow Cheung', displayNameZh: '張鶴翔', avatarUrl: '/images/players/sparrow-cheung.svg', region: 'HK', isVerified: true, memberSince: '2022-05-10',
    ...
    bio: 'Hong Kong poker legend. GPI Asia ranked.',
    bioZh: '香港撲克傳奇。GPI亞洲排名選手。',
  },
  { id: 'p9', displayName: 'Elton Tsang', displayNameZh: '曾恩明', avatarUrl: '/images/players/elton-tsang.svg', region: 'HK', isVerified: true, memberSince: '2022-01-15',
    ...
    bio: 'Hong Kong high-stakes legend. Won $1.697M Triton Poker title in 2025.',
    bioZh: '香港高額賽傳奇。2025年贏得169.7萬美元Triton Poker冠軍。',
  },
  { id: 'p10', displayName: 'Chih Wei Chen', displayNameZh: '陳志偉', avatarUrl: '/images/players/chih-wei-chen.svg', region: 'TW', isVerified: true, memberSince: '2024-01-20',
    ...
    bio: '#5 in Taiwan SPI 2025.',
    bioZh: '2025年台灣SPI第五名。',
  },
  { id: 'p11', displayName: 'Li Ta Hsu', displayNameZh: '許力達', avatarUrl: '/images/players/li-ta-hsu.svg', region: 'TW', isVerified: true, memberSince: '2024-03-10',
    ...
    bio: '#7 in Taiwan SPI 2025.',
    bioZh: '2025年台灣SPI第七名。',
  },
  { id: 'p12', displayName: 'Fung Lin', displayNameZh: '林鋒', avatarUrl: '/images/players/fung-lin.svg', region: 'HK', isVerified: true, memberSince: '2023-06-20',
    ...
    bio: 'Won APT Championship 2025 Trip Saver Championship ($71,994).',
    bioZh: '贏得2025年APT年度總冠軍旅行者冠軍賽（$71,994）。',
  },
  { id: 'p13', displayName: 'Tony Lin', displayNameZh: '林仁', avatarUrl: '/images/players/tony-lin.svg', region: 'TW', isVerified: true, memberSince: '2022-01-01',
    ...
    bio: 'WPT Ambassador. Over $18M in live tournament earnings. Multiple WPT and WSOP final tables.',
    bioZh: 'WPT大使。現場錦標賽收入超過1800萬美元。多次WPT和WSOP決賽桌。',
  },
  { id: 'p14', displayName: 'Eric Tsai', displayNameZh: '小六', avatarUrl: '/images/players/eric-tsai.svg', region: 'TW', isVerified: true, memberSince: '2022-03-15',
    ...
    bio: 'Taiwan GPI #1 ranked player. Known as SixPoker. Over $5.2M in live earnings.',
    bioZh: '台灣GPI排名第一選手。以「小六」聞名。現場收入超過520萬美元。',
  },
  { id: 'p15', displayName: 'Charlie Chiu', displayNameZh: '查理', avatarUrl: '/images/players/charlie-chiu.svg', region: 'HK', isVerified: true, memberSince: '2022-06-01',
    ...
    bio: 'Natural8 Ambassador and Hong Kong poker star. Over $3.8M in live earnings.',
    bioZh: 'Natural8大使，香港撲克明星。現場收入超過380萬美元。',
  },
];

const playerIds = {};
for (let i = 1; i <= 15; i++) {
  playerIds[`p${i}`] = `00000000-0000-0000-0000-${String(i).padStart(12, '0')}`;
}
...
async function seed() {
  ...
  for (const table of ['reviews', 'transactions', 'investments', 'escrow', 'listings', 'tournaments', 'monthly_roi', 'testimonials', 'player_stats', 'profiles']) {
  ...
  console.log('👤 Creating 15 players...');
  for (const p of players) {
    ...
    if (authErr) console.warn(`  ⚠ Auth ${p.id}: ${authErr.message}`);
    else console.log(`  ✓ ${p.displayName} (${p.displayNameZh})`);
    ...
    for (const m of p.stats.monthlyROI) {
      await admin.from('monthly_roi').insert({ player_id: uuid, month: m.month, roi: m.roi });
    }
  }
  ...
  const tournaments = [
    { id: 't1', name: 'APT National Cup', nameZh: 'APT國家盃', venue: 'Red Space, Taipei', venueZh: 'Red Space，台北', date: '2026-04-22', buyIn: 380, guaranteedPool: 475000, type: 'MTT', game: 'NLHE', region: 'TW' },
    { id: 't2', name: 'APT Mystery Bounty', nameZh: 'APT神秘賞金賽', venue: 'Red Space, Taipei', venueZh: 'Red Space，台北', date: '2026-04-25', buyIn: 635, guaranteedPool: 635000, type: 'MTT', game: 'NLHE', region: 'TW' },
    { id: 't3', name: 'APT Super High Roller', nameZh: 'APT超高額賽', venue: 'Asia Poker Arena, Taipei', venueZh: 'Asia Poker Arena，台北', date: '2026-04-25', buyIn: 10500, guaranteedPool: 475000, type: 'MTT', game: 'NLHE', region: 'TW' },
    { id: 't4', name: 'APT Taipei Main Event', nameZh: 'APT台北主賽事', venue: 'Red Space, Taipei', venueZh: 'Red Space，台北', date: '2026-04-26', buyIn: 1745, guaranteedPool: 2220000, type: 'MTT', game: 'NLHE', region: 'TW' },
    { id: 't5', name: 'APT Sunday Superstack', nameZh: 'APT週日超深籌碼賽', venue: 'Red Space, Taipei', venueZh: 'Red Space，台北', date: '2026-04-26', buyIn: 950, guaranteedPool: 159000, type: 'MTT', game: 'NLHE', region: 'TW' },
    { id: 't6', name: 'APT High Roller', nameZh: 'APT高額賽', venue: 'Asia Poker Arena, Taipei', venueZh: 'Asia Poker Arena，台北', date: '2026-04-28', buyIn: 2220, guaranteedPool: 475000, type: 'MTT', game: 'NLHE', region: 'TW' },
    { id: 't7', name: 'APT High Roller Ultra Stack', nameZh: 'APT高額超深籌碼賽', venue: 'Red Space, Taipei', venueZh: 'Red Space，台北', date: '2026-04-22', buyIn: 2060, guaranteedPool: 317000, type: 'MTT', game: 'NLHE', region: 'TW' },
    { id: 't8', name: 'Zodiac Classic', nameZh: '生肖經典賽', venue: 'Red Space, Taipei', venueZh: 'Red Space，台北', date: '2026-04-30', buyIn: 2700, guaranteedPool: 793000, type: 'MTT', game: 'NLHE', region: 'TW' },
    { id: 't9', name: 'APT Superstar Challenge', nameZh: 'APT明星挑戰賽', venue: 'Asia Poker Arena, Taipei', venueZh: 'Asia Poker Arena，台北', date: '2026-04-29', buyIn: 1430, guaranteedPool: 317000, type: 'MTT', game: 'NLHE', region: 'TW' },
    { id: 't10', name: 'APT Saturday Single Re-Entry', nameZh: 'APT週六單次重入賽', venue: 'Asia Poker Arena, Taipei', venueZh: 'Asia Poker Arena，台北', date: '2026-04-25', buyIn: 222, guaranteedPool: 32000, type: 'MTT', game: 'NLHE', region: 'TW' },
    { id: 't11', name: 'APT NL Holdem Freezeout', nameZh: 'APT凍結賽', venue: 'Asia Poker Arena, Taipei', venueZh: 'Asia Poker Arena，台北', date: '2026-04-25', buyIn: 1110, guaranteedPool: 95000, type: 'MTT', game: 'NLHE', region: 'TW' },
    { id: 't12', name: 'TMT 20 Main Event', nameZh: 'TMT 20 主賽事', venue: 'CTP Club, Taipei', venueZh: 'CTP協會，台北', date: '2026-07-15', buyIn: 1600, guaranteedPool: 1500000, type: 'MTT', game: 'NLHE', region: 'TW' },
    { id: 't13', name: 'TMT 20 High Roller', nameZh: 'TMT 20 高額賽', venue: 'CTP Club, Taipei', venueZh: 'CTP協會，台北', date: '2026-07-20', buyIn: 5000, guaranteedPool: 500000, type: 'MTT', game: 'NLHE', region: 'TW' },
    { id: 't14', name: 'TMT Championship 2026 Main Event', nameZh: 'TMT錦標賽2026主賽事', venue: 'CTP Club, Taipei', venueZh: 'CTP協會，台北', date: '2026-10-18', buyIn: 2000, guaranteedPool: 1000000, type: 'MTT', game: 'NLHE', region: 'TW' },
    { id: 't15', name: 'APT Championship 2026 Main Event', nameZh: 'APT年度總冠軍賽2026主賽事', venue: 'Red Space, Taipei', venueZh: 'Red Space，台北', date: '2026-11-20', buyIn: 10000, guaranteedPool: 5000000, type: 'MTT', game: 'NLHE', region: 'TW' },
  ];

  const tournamentIds = {};
  for (const t of tournaments) {
    const { data, error } = await admin.from('tournaments').insert({
      name: t.name, name_zh: t.nameZh, venue: t.venue, venue_zh: t.venueZh,
      date: new Date(t.date).toISOString(), buy_in: t.buyIn, guaranteed_pool: t.guaranteedPool,
      type: t.type, game: t.game, region: t.region,
    }).select('id').single();
    if (error) console.warn(`  ⚠ ${t.name}: ${error.message}`);
    else { tournamentIds[t.id] = data.id; console.log(`  ✓ ${t.name}`); }
  }
  ...
  for (const l of listings) {
    if (!tournamentIds[l.tournamentId]) continue;
    ...
    if (error) console.warn(`  ⚠ ${l.id}: ${error.message}`);
    else console.log(`  ✓ ${l.id}`);
  }
  ...
  for (const t of testimonials) {
    await admin.from('testimonials').insert({ name: t.name, name_zh: t.nameZh, role: t.role, avatar: t.avatar, quote: t.quote, quote_zh: t.quoteZh, region: t.region, is_active: true });
  }
  ...
  const reviews = [
    { playerId: 'p1', reviewerId: 'inv1', reviewerName: 'Alex T.', reviewerAvatar: '/avatars/inv1.svg', rating: 5, comment: 'Incredibly consistent player.', commentZh: '非常穩定的選手。', createdAt: '2026-02-15T10:00:00Z' },
    { playerId: 'p1', reviewerId: 'inv2', reviewerName: 'Jenny L.', reviewerAvatar: '/avatars/inv2.svg', rating: 4, comment: 'Solid player with good track record.', commentZh: '實力堅固的選手。', createdAt: '2026-01-28T14:30:00Z' },
    { playerId: 'p2', reviewerId: 'inv3', reviewerName: 'Robert K.', reviewerAvatar: '/avatars/inv3.svg', rating: 5, comment: 'Phenomenal player. Best investment on the platform.', commentZh: '非凡的選手。平台上最好的投資。', createdAt: '2026-03-01T09:15:00Z' },
    { playerId: 'p3', reviewerId: 'inv1', reviewerName: 'Alex T.', reviewerAvatar: '/avatars/inv1.svg', rating: 4, comment: 'Veteran with deep tournament experience.', commentZh: '經驗豐富的老將。', createdAt: '2026-02-20T16:45:00Z' },
    { playerId: 'p4', reviewerId: 'inv4', reviewerName: 'Mike W.', reviewerAvatar: '/avatars/inv4.svg', rating: 5, comment: 'ROI speaks for itself. One of the best.', commentZh: 'ROI不言自明。最好的之一。', createdAt: '2026-03-05T11:30:00Z' },
    { playerId: 'p9', reviewerId: 'inv2', reviewerName: 'Jenny L.', reviewerAvatar: '/avatars/inv2.svg', rating: 5, comment: 'True professional. Always keeps backers informed.', commentZh: '真正的職業選手。總是讓支持者了解最新情況。', createdAt: '2026-02-10T08:00:00Z' },
    { playerId: 'p13', reviewerId: 'inv1', reviewerName: 'Alex T.', reviewerAvatar: '/avatars/inv1.svg', rating: 5, comment: 'Tony Lin is a superstar. The best investment I have ever made.', commentZh: 'Tony Lin是超級巨星。我做過最好的投資。', createdAt: '2026-03-08T12:00:00Z' },
    { playerId: 'p14', reviewerId: 'inv3', reviewerName: 'Robert K.', reviewerAvatar: '/avatars/inv3.svg', rating: 5, comment: 'SixPoker dominates the Taiwan circuit. Incredible returns.', commentZh: '小六統治台灣巡迴賽。回報驚人。', createdAt: '2026-03-06T16:00:00Z' },
    { playerId: 'p15', reviewerId: 'inv4', reviewerName: 'Mike W.', reviewerAvatar: '/avatars/inv4.svg', rating: 4, comment: 'Charlie is a reliable backer choice. Strong HK performer.', commentZh: '查理是可靠的支持選擇。強大的香港選手。', createdAt: '2026-03-04T09:00:00Z' },
  ];
  ...
  for (const r of reviews) {
    ...
    await admin.from('profiles').update({ display_name: r.reviewerName, avatar_url: r.reviewerAvatar, role: 'investor' }).eq('id', reviewerUuid);
    ...
    console.log(`  ✓ Review for ${r.playerId} by ${r.reviewerName}`);
  }

  // Final check
  const { data: profileCount } = await admin.from('profiles').select('*', { count: 'exact', head: true });
  console.log('\n✅ Seed complete!');
  console.log(`   Players: 15`);
